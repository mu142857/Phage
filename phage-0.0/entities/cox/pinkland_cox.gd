...
@export var max_health: int = 4400
@export var health: int = 4400
@export var idle_hover_amplitude: float = 15.0
@export var idle_hover_speed: float = 2.2
@export var hover_follow_speed: float = 31.0
@export var chase_speed: float = 22.5
...
func _set_attack_glow(enabled: bool, immediate: bool = false) -> void:
	...
	if enabled:
		target_modulate = Color(3.0, 3.0, _base_modulate.b, _base_modulate.a)
